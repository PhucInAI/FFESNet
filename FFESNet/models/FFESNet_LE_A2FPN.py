...
from FFESNet.models.pyramids.a2fpn import A2FPN
from FFESNet.models.pyramids.le import LocalEmphasisLayer
...
class FFESNet(nn.Module):
    ...
    def __init__(self, model_type = 'B0', dropout = 0.1, embedding_dim = 160):
        ...
        # ----------------------------------------------------------------
        self.pyramid = A2FPN(encoder_channels=[
    ...
    def forward(self, x):
        ...
        # Pyramid and prediction
        # ----------------------------------------------------------------
        out = self.pyramid([out_1, out_2, out_3, out_4])
